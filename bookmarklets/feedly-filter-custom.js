...
window.avoid += ', Capella Software, Tonica Fugata';
window.avoid += '';
window.avoid += '';
...
window.avoid += ', YTD Video, DVDInfo';
window.avoid += '';
window.avoid += '';
...
window.avoid += ', Air Explorer Pro, Pale Moon 2';
window.avoid += '';
window.avoid += '';
...
window.avoid += ', Hosts File Editor v1, Hosts File Editor 1, Cameyo 3';
window.avoid += '';
...
window.avoid += ', Zemana AntiMalware, Malware Hunter, EMCO Malware, Malwarebytes Anti, RogueKiller';
...
window.avoid += ', SoftMaker Office, EssentialPIM Pro 7, EveryLang Pro 2, EveryLang Pro v2, PDF Creator Pro';
window.avoid += ', Foxit Reader, SimpleMind, Desktop Calendar, InDesign, Turbo Studio';
window.avoid += ', Quick Access Popup, Password Vault Manager, Altium Designer, XnViewMP';
window.avoid += ', Save Me 2, Save Me v2, Save Me 3, Save Me v3, EMDB, Swift To Do, AirParrot';
window.avoid += ', EveryLang 2, EveryLang v2';
window.avoid += '';
window.avoid += '';
...
window.avoid += ', BATExpert, Virtualbox v';
